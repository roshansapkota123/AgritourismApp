...
const ScannerScreen = (props) => {
  ...
  const handleBarCodeScanned = (items) => {
    ...
    let cartId = arrayOfObjects.itemsInCart[0][0].CartId;
    let transId = arrayOfObjects.itemsInCart[0][1].TransId;
    ...
    fetch(`${SERVER_ROOT}/api/Transactions/redeem/${cartId}/${transId}`, {
      ...
      .then((res) => {
        if (res.ok) {
          ...
          Alert.alert("The transaction has already been redeemed.");
        }
      })
      .catch((error) => {
    ...
    let testArr = [...arrayOfObjects.itemsInCart[0][3]];
    setArray(testArr);
    setRenderModal(true);
  };
              ...
              {Object.keys(array).map((item, i) => {
                return (
                  <ListItem
                    ...
                    leftIcon={{ name: "star" }}
                    style={{ width: 320 }} // style for length of divider
                    bottomDivider
                  />
                );
              })}
              <ListItem
                subtitle={
                  ...
                  >
                    ...
                    >
                      Total Price: ${itemsInCart.itemsInCart[0][2].TotalPrice}
                    </Text>
                  </View>
                }
