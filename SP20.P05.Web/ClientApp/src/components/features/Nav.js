          ...
          <AppBar position="static" color="primary" elevation={0} className={classes.appBar}>
            <Toolbar className={classes.toolbar}>
              ...
              <nav>
                ...
                {userData == null ? <Link to="/signup" className={classes.link}>Signup</Link>
                  : <div></div>}
          ...
          <AppBar position="static" color="primary" elevation={0} className={classes.appBar}>
            <Toolbar className={classes.toolbar}>
              ...
              <nav>
                ...
                <Link to="/contact" className={classes.link}>Contact</Link>
                {userData == null ? <Link to="/login" className={classes.link}> Login</Link> : <Link to="/login" className={classes.link} onClick={this.handleLogout}>Logout</Link>}
                {userData.username == "admin" ? <Link to="/all-details" className={classes.link}>Admin</Link>
                  : <Link to="/details" className={classes.link}>History</Link>}
                {userData == null ? <Link to="/signup" className={classes.link}>Signup</Link>
                  : <div></div>}
              </nav>
            </Toolbar>
